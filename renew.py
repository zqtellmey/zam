...
# -*- coding: utf-8 -*-
"""
Zampto 自动续期脚本 - 初始登录页截图通知 + 双重 CF 穿透机制焊死版
"""
...
# --- 【升级修改：初始进站即截图发TG】基于 JS 成功经验的登录流程 ---
def login(sb, user: str, pwd: str) -> bool:
    ...
    try:
        ...
        # 【修改点 1】一打开登录页，做任何元素操作前，立刻截图并发送 TG 通知
...
# --- 续期逻辑 (移除了所有时间获取和对比，点击穿透后即完成，内部调度升级后的双重CF机制) ---
